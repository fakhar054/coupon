      ...
      <footer className="footer">
        <div className="footer-section">
          ...
          <ul> 
            ...
            <li>
              <Link to="/allgemeinegeschäftsbedingungen">{t('terms_condition')}</Link>
            </li>
          </ul>
        </div>
        <div className="footer-section"> 
          <>
            <h4 className="custom-page-title" style={{ visibility: 'hidden' }}>{t('custom_pages')}</h4>
            <style>
              {`
        ...
        `}
          ...
          <ul>
            {customPages.map((page) => (
              <li>
                <Link to={`/Seite/${page.slug}`} style={{ marginRight: '10px' }}>
                  {page.page_name}
                </Link>
              </li>
        ...
        <div className="footer-section footer-logo-section">
          <Link to="/">
            <img src={apiUrl + footerLogo} alt="Logo" width={142} height={40} className="footer-logo" />
          </Link>
          <ul>
            <li>
              <span>
