...
const ContainerItem = React.memo(
  ({
    container,
    openDetails,
    toggleDetails,
            ...
            <div className="container-header">
              <div className="container-type-percentage">
                <div className="container-image">
                  <img
                    src={
                      container.store?.banner
                        ? apiUrl + container.store.banner
                        : bannerImage
                    }
                    alt="add image"
                  />
              ...
              <div className="mobile-container">
                ...
                <div className="container-info">
                  {container.code === null ? (
                    ...
                    // </button>
                    <button
                      className="coupon-code-button with_Code"
                      onClick={(e) => {
          ...
          <div className="col-sm-4 col-md-4 col-lg-4 viewbutton">
            <div className="container-info">
              {container.code === null ? (
                ...
                >
                  <button
                    className="card-button code_null"
                    onClick={() => handleOffer(container)}
                    style={{ borderRadius: "5px" }}
                  >
                    {t("see_the_promo")}
...
const ContainerList = ({
  ...
  const toggleDetailsMain = useCallback(
    (id) => setOpenDetailsMain((prev) => (prev === id ? null : id)),
    []
  );
  const toggleDetailsSimilar = useCallback(
    (id) => setOpenDetailsSimilar((prev) => (prev === id ? null : id)),
    []
  );
  ...
  const activeContainers = useMemo(
    () => containers.filter((c) => new Date(c.expire_date) >= today),
    [containers, today]
  );
  const expiredContainers = useMemo(
    () => containers.filter((c) => new Date(c.expire_date) < today),
    [containers, today]
  );
  ...
  if (!containers || containers.length === 0)
    return <div className="container-listNotfound"></div>;
